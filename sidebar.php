    ...
    <!-- /search box -->
      ...
      <div class="recent-post-container">
        <h4>Recent Posts</h4>
            <?php
            include 'config.php';
            $sql="SELECT * FROM `post` INNER JOIN `user` ON post.author=user.user_id INNER JOIN `category` ON post.category=category.category_id ORDER BY `post_id` DESC LIMIT 5";
